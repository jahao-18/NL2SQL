(function () {
  ...
  window.NL2SQLApi = {
    ...
    gradeRoster: (id) => request(`/api/teaching/classes/${encodeURIComponent(id)}/grade-roster`),
    downloadGradeTemplate: (id, fileName) => download(`/api/teaching/classes/${encodeURIComponent(id)}/grade-template.csv`, fileName || "总评成绩导入模板.csv"),
    importGradeCsv: (id, payload) => json("POST", `/api/teaching/classes/${encodeURIComponent(id)}/grade-imports`, payload),
